    ...
    return (
      <div className="grid grid-cols-5 gap-x-24 gap-y-32 text-lg items-center">
        <div className="col-span-3">
          <h1 className="text-4xl mb-10 text-colors-accent-400 font-medium">
        ...
        <div className="col-span-3">
          ...
          <div className="space-y-8">
            ...
            <div>
              <a
                href="/cabins"
                className="inline-block mt-4 bg-colors-accent-500 px-8 py-5 text-colors-primary-800 text-lg font-semibold hover:bg-colors-accent-600 transition-all"
              >
